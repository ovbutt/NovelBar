...
public class RecycleVerticalAdapterFrag2 extends RecyclerView.Adapter<RecycleVerticalAdapterFrag2.MyViewHolder> {
    ...
    public RecycleVerticalAdapterFrag2(Context ctx, String[] mDataSet) {
    ...
    public void onBindViewHolder(@NonNull final MyViewHolder myViewHolder, final int i) {
        ...
        myViewHolder.btnImageMinus.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                SharedPreferences sharedPreferences1 = ctx.getSharedPreferences("Pref2", 0);
...
//                if (defaultFlag) {
//                   // myViewHolder.editNumber.setText("7");
//                   myViewHolder.btnImagePluse.setVisibility(GONE);
//                    defaultFlag = false;
//                    return;
//                }
...
//                            }
                ...
                Log.d(TAG, "onClick: Value of default flag: " + defaultFlag);
                }
        });
...
//        });
    ...
    private void testDialogue() {
        ...
        {
            case 0:
                tvHeading.setText("Soy");
                caloriesTV.setText("92.7");
                carbCaloriesTV.setText("35.1");
                fatCaloriesTV.setText("1.1");
                proteinCaloriesTV.setText("56.5");
                rdaTV.setText("5");
                portionSizeTV.setText("1");
                break;
            case 1:

                tvHeading.setText("Whey Powder");
                caloriesTV.setText("193");
                carbCaloriesTV.setText("162");
                fatCaloriesTV.setText("2.7");
                proteinCaloriesTV.setText("28.6");
                rdaTV.setText("10");
                portionSizeTV.setText("1");
                break;

            case 2:
                tvHeading.setText("Spinulina");
                caloriesTV.setText("325");
                carbCaloriesTV.setText("95.4");
                fatCaloriesTV.setText("72.4");
                proteinCaloriesTV.setText("157");
                rdaTV.setText("16");
                portionSizeTV.setText("1");
                break;
        }
