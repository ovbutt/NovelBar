...
public class RecycleVerticalAdapterFrag3 extends RecyclerView.Adapter<RecycleVerticalAdapterFrag3.MyViewHolder> {
...
//    private IngredientsQuantitiyHelper ingredientsQuantitiyHelper = new IngredientsQuantitiyHelper();
    ...
    public RecycleVerticalAdapterFrag3(Context ctx, String[] mDataSet) {
    ...
    public void onBindViewHolder(@NonNull final MyViewHolder myViewHolder, final int i) {
        ...
        myViewHolder.btnImageMinus.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                SharedPreferences sharedPreferences1 = ctx.getSharedPreferences("Pref3", 0);
                ...
                event.setCustomMessage(String.valueOf(-0.1));
    ...
    private void testDialogue() {
        ...
        {
            case 0:
                tvHeading.setText("Vitamin B,C,D" + "\n" + "Complex");
                caloriesTV.setText("0");
                carbCaloriesTV.setText("0");
                fatCaloriesTV.setText("0");
                proteinCaloriesTV.setText("0");
                rdaTV.setText("0");
                portionSizeTV.setText("0.1");
                break;
        }
