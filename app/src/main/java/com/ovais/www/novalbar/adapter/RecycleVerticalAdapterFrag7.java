...
public class RecycleVerticalAdapterFrag7 extends RecyclerView.Adapter<RecycleVerticalAdapterFrag7.MyViewHolder> {
...
//    private IngredientsQuantitiyHelper ingredientsQuantitiyHelper = new IngredientsQuantitiyHelper();
    ...
    public RecycleVerticalAdapterFrag7(Context ctx, String[] mDataSet) {
    ...
    public void onBindViewHolder(@NonNull final MyViewHolder myViewHolder, final int i) {
        ...
        myViewHolder.btnImageMinus.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                SharedPreferences sharedPreferences1 = ctx.getSharedPreferences("Pref7", 0);
...
//        });
    ...
    private void testDialogue() {
        ...
        {
            case 0:
                tvHeading.setText("Cranberries");
                caloriesTV.setText("123");
                carbCaloriesTV.setText("119");
                fatCaloriesTV.setText("4.6");
                proteinCaloriesTV.setText("0.1");
                rdaTV.setText("6");
                portionSizeTV.setText("1");
                break;
            case 1:

                tvHeading.setText("Apricots");
                caloriesTV.setText("313");
                carbCaloriesTV.setText("293");
                fatCaloriesTV.setText("5.6");
                proteinCaloriesTV.setText("14.8");
                rdaTV.setText("16");
                portionSizeTV.setText("1");
                break;

            case 2:
                tvHeading.setText("Banan Chips");
                caloriesTV.setText("346");
                carbCaloriesTV.setText("318");
                fatCaloriesTV.setText("15.2");
                proteinCaloriesTV.setText("13.1");
                rdaTV.setText("17");
                portionSizeTV.setText("1");
                break;
            case 3:
                tvHeading.setText("Dates");
                caloriesTV.setText("415");
                carbCaloriesTV.setText("398");
                fatCaloriesTV.setText("4.8");
                proteinCaloriesTV.setText("12.1");
                rdaTV.setText("21");
                portionSizeTV.setText("1");
                break;
        }
