...
import com.ovais.www.novalbar.adapter.RecycleVerticalAdapterFrag6;
...
public class Frag6 extends Fragment {
    ...
    private String []nuts = {"Pecans","Cashews","Pine","Peanuts","Walnuts", "Almonds",};
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mAdapter = new RecycleVerticalAdapterFrag6(getContext(), nuts);
