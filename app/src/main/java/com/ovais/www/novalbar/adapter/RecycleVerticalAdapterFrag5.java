...
public class RecycleVerticalAdapterFrag5 extends RecyclerView.Adapter<RecycleVerticalAdapterFrag5.MyViewHolder> {
   ...
   // private IngredientsQuantitiyHelper ingredientsQuantitiyHelper = new IngredientsQuantitiyHelper();
    ...
    public RecycleVerticalAdapterFrag5(Context ctx, String[] mDataSet) {
    ...
    public void onBindViewHolder(@NonNull final MyViewHolder myViewHolder, final int i) {
        ...
        myViewHolder.btnImageMinus.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                SharedPreferences sharedPreferences1 = ctx.getSharedPreferences("Pref5", 0);
...
//        });
    ...
    private void testDialogue() {
        ...
        {
            case 0:
                tvHeading.setText("Beans");
                caloriesTV.setText("723");
                carbCaloriesTV.setText("493");
                fatCaloriesTV.setText("101");
                proteinCaloriesTV.setText("134");
                rdaTV.setText("36");
                portionSizeTV.setText("1");
                break;
            case 1:

                tvHeading.setText("Kale");
                caloriesTV.setText("128");
                carbCaloriesTV.setText("50");
                fatCaloriesTV.setText("70.2");
                proteinCaloriesTV.setText("8");
                rdaTV.setText("6.4");
                portionSizeTV.setText("1");
                break;

            case 2:
                tvHeading.setText("Carrots");
                caloriesTV.setText("252");
                carbCaloriesTV.setText("226");
                fatCaloriesTV.setText("9.2");
                proteinCaloriesTV.setText("16.7");
                rdaTV.setText("3");
                portionSizeTV.setText("1");
                break;
            case 3:
                tvHeading.setText("Beets");
                caloriesTV.setText("100");
                carbCaloriesTV.setText("90");
                fatCaloriesTV.setText("0");
                proteinCaloriesTV.setText("10");
                rdaTV.setText("5");
                portionSizeTV.setText("1");
                break;
        }
