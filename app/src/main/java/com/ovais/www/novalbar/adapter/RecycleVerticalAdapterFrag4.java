...
public class RecycleVerticalAdapterFrag4 extends RecyclerView.Adapter<RecycleVerticalAdapterFrag4.MyViewHolder> {
...
//    private IngredientsQuantitiyHelper ingredientsQuantitiyHelper = new IngredientsQuantitiyHelper();
    ...
    public RecycleVerticalAdapterFrag4(Context ctx, String[] mDataSet) {
    ...
    public void onBindViewHolder(@NonNull final MyViewHolder myViewHolder, final int i) {
        ...
        myViewHolder.btnImageMinus.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                SharedPreferences sharedPreferences1 = ctx.getSharedPreferences("Pref4", 0);
...
//        });
    ...
    private void testDialogue() {
        ...
        {
            case 0:
                tvHeading.setText("Soluble Fiber");
                caloriesTV.setText("300");
                carbCaloriesTV.setText("225");
                fatCaloriesTV.setText("45");
